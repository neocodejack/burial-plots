...
var GetDataRich = function (id) {
    ...
    $.ajax({
        url: "/Admin/Page/edit",
        type: "Post",
        data: {id:id, html: value, tittle: tittle, servicebox: multivlaue, image: imagename, bodyUrdu: bodyUrdu, bodyArabic: bodyArabic,
...
$("#txttittle").keyup(function () {
    ...
    $("#pageurl").val("/Admin/Page/PageView/" + value);
...
var appendCodeonTextEditor = function () {
    var code = $("#show").val();
    //$("#editornew").html(code);
    quill.container.firstChild.innerHTML = code;
}
